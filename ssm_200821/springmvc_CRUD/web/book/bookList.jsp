    ...
    <table>
        ...
        <c:forEach items="${requestScope.page.items}" var="book">
            <tr>
                ...
                <td>${book.sales}</td>
                <td>${book.stock}</td>
                <form action="${pageContext.request.contextPath}/book/${param.pageNo}/${book.id}" method="post">
                    <input type="hidden" name="_method" value="DELETE"/>
                </form>
                <td><a href="#" class="delete">删除</a></td>
                <td>
                    <a href="${pageContext.request.contextPath}/book/getBook?pageNo=${param.pageNo}&id=${book.id}">修改</a>
                </td>
            </tr>
        </c:forEach>
    </table>
